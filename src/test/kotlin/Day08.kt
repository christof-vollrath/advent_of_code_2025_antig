...
fun buildCircuits(coords: List<Coord3>, sortedDistances: List<CoordsWithDistance>): Pair<List<Int>, Pair<Coord3, Coord3>?> = buildCircuitsUnionFind(coords, sortedDistances)
